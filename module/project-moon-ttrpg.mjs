...
import { ProjectMoonActor } from './documents/actor.mjs';
import { ProjectMoonItem } from './documents/item.mjs';
// Import sheet classes.
import { ProjectMoonActorSheet } from './sheets/actor-sheet.mjs';
import { ProjectMoonItemSheet } from './sheets/item-sheet.mjs';
...
Hooks.once('init', function () {
  ...
  CONFIG.Item.dataModels = {
    item: models.ProjectMoonItem,
    feature: models.ProjectMoonFeature,
    spell: models.ProjectMoonSpell
  }
  ...
  Items.registerSheet('project-moon-ttrpg', ProjectMoonItemSheet, {
    makeDefault: true,
    label: 'PROJECT_MOON.SheetLabels.Item',
  });
